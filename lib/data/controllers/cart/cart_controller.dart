...
//******************************************* variabels *******************************************/
  ...
  Rx<Color> promoCodeMessageColor = AppColors.dark.obs;
  ...
  void addItemWithDefaultVariations(Product product) {
    ...
    if (!isProductExist(product.id)) {
      ...
      cartItemsList.add(CartItemModel(
        ...
        itemId: "${product.productVariations[0].attributeValues!.color}${product.productVariations[0].attributeValues!.size}",
        title: product.title,
        price: product.price,
        image: product.images.first,
        quantity: 1,
        brandName: product.brand.name,
        selectedVariation: AttreibuteValues(
          color: product.productVariations[0].attributeValues!.color,
          size: product.productVariations[0].attributeValues!.size,
        ),
      ));
