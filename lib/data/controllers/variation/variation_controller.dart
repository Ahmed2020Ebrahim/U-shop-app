...
import 'package:ushop/data/models/products/product_variations_model.dart';
import 'package:ushop/utils/popups/app_popups.dart';
...
class VariationController extends GetxController {
  ...
  Rx<AttreibuteValues> selectedAttributes = AttreibuteValues.emptyAttreibuteValuesModel().obs;
  Rx<AttreibuteValues> defaultAttributesValues = AttreibuteValues.emptyAttreibuteValuesModel().obs;
  ...
  void _reSetCurrentCartItem() {
    ...
    currentCartItem.value = CartItemModel(
      productId: data.id,
      itemId: "${data.productVariations[0].attributeValues!.color}${data.productVariations[0].attributeValues!.size}",
      title: data.title,
      price: data.price,
      image: data.images[0],
      quantity: 0,
